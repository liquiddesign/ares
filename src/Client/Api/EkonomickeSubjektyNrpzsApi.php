...
use Ares\Client\Configuration;
use Ares\Client\HeaderSelector;
...
class EkonomickeSubjektyNrpzsApi
{
     ...
     *
     * @throws \Ares\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Ares\Client\Model\EkonomickySubjektNrpzs
     */
     ...
     * @throws \Ares\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Ares\Client\Model\EkonomickySubjektNrpzs, HTTP status code, HTTP response headers (array of strings)
     */
    public function vratEkonomickySubjektNrpzsWithHttpInfo($ico)
    {
        $returnType = '\Ares\Client\Model\EkonomickySubjektNrpzs';
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Ares\Client\Model\EkonomickySubjektNrpzs',
     ...
     *
     * @param  \Ares\Client\Model\EkonomickeSubjektyRegistraceFiltr $body body (optional)
     *
     * @throws \Ares\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Ares\Client\Model\EkonomickeSubjektyNrpzsSeznam
     */
     ...
     *
     * @param  \Ares\Client\Model\EkonomickeSubjektyRegistraceFiltr $body (optional)
     *
     * @throws \Ares\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Ares\Client\Model\EkonomickeSubjektyNrpzsSeznam, HTTP status code, HTTP response headers (array of strings)
     */
    public function vyhledejSeznamEkonomickychSubjektuNrpzsWithHttpInfo($body = null)
    {
        $returnType = '\Ares\Client\Model\EkonomickeSubjektyNrpzsSeznam';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Ares\Client\Model\EkonomickeSubjektyNrpzsSeznam',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
