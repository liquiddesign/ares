...
class ProvozovnaZaklad implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        'sidlo_provozovny' => '\Ares\Client\Model\Adresa',
        'umisteni_provozovny' => 'string',
        'platnost_od' => '\DateTime',
        'platnost_do' => '\DateTime',
        'pozastaveni_provozovny' => '\Ares\Client\Model\ZivnostProvozovnaPozastaveni[]',
     ...
     *
     * @param \Ares\Client\Model\Adresa $sidlo_provozovny sidlo_provozovny
     *
     * @return $this
     */
     ...
     *
     * @param \Ares\Client\Model\ZivnostProvozovnaPozastaveni[] $pozastaveni_provozovny pozastaveni_provozovny
     *
     * @return $this
     */
