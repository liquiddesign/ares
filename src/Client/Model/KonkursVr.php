 ...
 *
 * @category Class
 * @description &amp;#218;daj s s informac&amp;#237; z konkurzn&amp;#237;ho ř&amp;#237;zen&amp;#237;
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class KonkursVr extends DatumZapisuVymazuUdajeVr 
{
    ...
    protected static $swaggerTypes = [
        'spravce' => '\Ares\Client\Model\AngazmaOsobaVr[]',
        'typ_konkursu' => 'string',
        'datum_rozhodnuti_os' => '\DateTime',
        'datum_vyveseni' => '\DateTime',
        'spis_zn_os' => 'string',
        'text' => 'string',
        'zruseni_konkursu' => '\Ares\Client\Model\ObecnyTextVr[]'
    ];
     ...
     * Sets spravce
     *
     * @param \Ares\Client\Model\AngazmaOsobaVr[] $spravce spravce
     *
     * @return $this
     */
     ...
     *
     * @param \Ares\Client\Model\ObecnyTextVr[] $zruseni_konkursu zruseni_konkursu
     *
     * @return $this
     */
