...
class ZaznamVrZaklad implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        'akcie' => '\Ares\Client\Model\EmiseAkcieVr[]',
        'rejstrik' => 'string',
        'primarni_zaznam' => 'bool',
        'spisova_znacka' => '\Ares\Client\Model\SpisovaZnackaVr[]',
        'ico' => '\Ares\Client\Model\IcoVr[]',
        'obchodni_jmeno' => '\Ares\Client\Model\ObchodniJmenoVr[]',
        'vklady' => '\Ares\Client\Model\VkladVr[]',
        'obchodni_jmeno_cizi' => '\Ares\Client\Model\ObchodniJmenoCiziVr[]',
        'zakladni_kapital' => '\Ares\Client\Model\ZakladniKapitalVr[]',
        'pravni_forma' => '\Ares\Client\Model\PravniFormaVr[]',
        'financni_urad' => 'string',
        'adresy' => '\Ares\Client\Model\AdresaVr[]',
        'ostatni_skutecnosti' => '\Ares\Client\Model\ObecnyTextVr[]',
        'datum_aktualizace' => '\DateTime',
        'stav_subjektu' => 'string',
        'datum_vzniku' => '\Ares\Client\Model\DatumVr[]',
        'datum_zapisu' => '\DateTime',
        'datum_vymazu' => '\DateTime',
        'zpusob_rizeni' => '\Ares\Client\Model\ZpusobRizeniVr[]',
        'kategorie_zo' => '\Ares\Client\Model\KategorieZoVr[]',
        'pravni_duvod_vymazu' => '\Ares\Client\Model\ObecnyTextVr[]',
        'cinnosti' => '\Ares\Client\Model\CinnostiVr',
        'nazev_nejvyssiho_organu' => '\Ares\Client\Model\ObecnyTextVr[]',
        'exekuce' => '\Ares\Client\Model\ObecnyTextVr[]'
    ];
     ...
     * Gets akcie
     *
     * @return \Ares\Client\Model\EmiseAkcieVr[]
     */
     ...
     * Sets akcie
     *
     * @param \Ares\Client\Model\EmiseAkcieVr[] $akcie akcie
     *
     * @return $this
     */
     ...
     * Gets spisova_znacka
     *
     * @return \Ares\Client\Model\SpisovaZnackaVr[]
     */
     ...
     * Sets spisova_znacka
     *
     * @param \Ares\Client\Model\SpisovaZnackaVr[] $spisova_znacka spisova_znacka
     *
     * @return $this
     */
     ...
     * Gets ico
     *
     * @return \Ares\Client\Model\IcoVr[]
     */
     ...
     * Sets ico
     *
     * @param \Ares\Client\Model\IcoVr[] $ico ico
     *
     * @return $this
     */
     ...
     * Gets obchodni_jmeno
     *
     * @return \Ares\Client\Model\ObchodniJmenoVr[]
     */
     ...
     * Sets obchodni_jmeno
     *
     * @param \Ares\Client\Model\ObchodniJmenoVr[] $obchodni_jmeno obchodni_jmeno
     *
     * @return $this
     */
     ...
     * Gets vklady
     *
     * @return \Ares\Client\Model\VkladVr[]
     */
     ...
     * Sets vklady
     *
     * @param \Ares\Client\Model\VkladVr[] $vklady vklady
     *
     * @return $this
     */
     ...
     *
     * @return \Ares\Client\Model\ObchodniJmenoCiziVr[]
     */
     ...
     *
     * @param \Ares\Client\Model\ObchodniJmenoCiziVr[] $obchodni_jmeno_cizi obchodni_jmeno_cizi
     *
     * @return $this
     */
     ...
     *
     * @return \Ares\Client\Model\ZakladniKapitalVr[]
     */
     ...
     *
     * @param \Ares\Client\Model\ZakladniKapitalVr[] $zakladni_kapital zakladni_kapital
     *
     * @return $this
     */
     ...
     * Gets pravni_forma
     *
     * @return \Ares\Client\Model\PravniFormaVr[]
     */
     ...
     * Sets pravni_forma
     *
     * @param \Ares\Client\Model\PravniFormaVr[] $pravni_forma pravni_forma
     *
     * @return $this
     */
     ...
     * Gets adresy
     *
     * @return \Ares\Client\Model\AdresaVr[]
     */
     ...
     * Sets adresy
     *
     * @param \Ares\Client\Model\AdresaVr[] $adresy adresy
     *
     * @return $this
     */
     ...
     *
     * @param \Ares\Client\Model\ObecnyTextVr[] $ostatni_skutecnosti ostatni_skutecnosti
     *
     * @return $this
     */
     ...
     * Gets datum_vzniku
     *
     * @return \Ares\Client\Model\DatumVr[]
     */
     ...
     * Sets datum_vzniku
     *
     * @param \Ares\Client\Model\DatumVr[] $datum_vzniku datum_vzniku
     *
     * @return $this
     */
     ...
     * Gets zpusob_rizeni
     *
     * @return \Ares\Client\Model\ZpusobRizeniVr[]
     */
     ...
     * Sets zpusob_rizeni
     *
     * @param \Ares\Client\Model\ZpusobRizeniVr[] $zpusob_rizeni zpusob_rizeni
     *
     * @return $this
     */
     ...
     * Gets kategorie_zo
     *
     * @return \Ares\Client\Model\KategorieZoVr[]
     */
     ...
     * Sets kategorie_zo
     *
     * @param \Ares\Client\Model\KategorieZoVr[] $kategorie_zo kategorie_zo
     *
     * @return $this
     */
     ...
     *
     * @param \Ares\Client\Model\ObecnyTextVr[] $pravni_duvod_vymazu pravni_duvod_vymazu
     *
     * @return $this
     */
     ...
     * Gets cinnosti
     *
     * @return \Ares\Client\Model\CinnostiVr
     */
     ...
     * Sets cinnosti
     *
     * @param \Ares\Client\Model\CinnostiVr $cinnosti cinnosti
     *
     * @return $this
     */
     ...
     *
     * @param \Ares\Client\Model\ObecnyTextVr[] $nazev_nejvyssiho_organu nazev_nejvyssiho_organu
     *
     * @return $this
     */
     ...
     * Sets exekuce
     *
     * @param \Ares\Client\Model\ObecnyTextVr[] $exekuce exekuce
     *
     * @return $this
     */
