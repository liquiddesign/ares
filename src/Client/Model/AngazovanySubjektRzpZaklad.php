...
class AngazovanySubjektRzpZaklad implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        ...
        'sidlo' => '\Ares\Client\Model\AngazovanySubjektAdresa',
        'typ_subjektu' => 'string',
        'pravni_forma' => 'string',
        'kod_statu' => 'string'
    ];
     ...
     * Gets sidlo
     *
     * @return \Ares\Client\Model\AngazovanySubjektAdresa
     */
     ...
     * Sets sidlo
     *
     * @param \Ares\Client\Model\AngazovanySubjektAdresa $sidlo sidlo
     *
     * @return $this
     */
